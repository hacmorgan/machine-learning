...
yvec = zeros(m,numel(Theta2(:,1)));  % expand the y vector into a matrix of row vectors
for i = 1:m
  yvec(i,y(i)) = 1;
end
...
%
delta2 = h - yvec;
Theta2_grad = 1/m * delta2' * a1;
delta1 = delta2 * Theta2(:,2:end) .* sigmoidGradient(z1);
Theta1_grad = 1/m * delta1' * X;
